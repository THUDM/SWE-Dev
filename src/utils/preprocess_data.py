...
from src.localizer.get_repo_structure import (
    get_project_structure_from_scratch, parse_python_file)
from src.utils.parse_global_var import parse_global_var_from_code
